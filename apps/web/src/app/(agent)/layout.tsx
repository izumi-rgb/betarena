...
function AgentSidebar() {
  ...
  return (
    <aside className="flex h-screen w-[220px] shrink-0 flex-col border-r border-[#1E293B] bg-[#111827]">
      <div className="p-5">
      ...
      <div className="px-4 pb-4">
        <Link
          href="/settings"
          className="mb-4 flex items-center gap-3 rounded-md border-l-[3px] border-l-transparent px-4 py-2.5 text-[14px] font-medium text-[#94A3B8] transition-all hover:bg-[#1A2235] hover:text-white"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex items-center gap-3 rounded-lg border border-[#1E293B] bg-[#0B0E1A] p-3">
          <div className="h-8 w-8 rounded-full border border-[#1A2235] bg-gradient-to-br from-purple-500 to-blue-500" />
          <div className="min-w-0 flex-1">
            <div className="truncate text-[13px] font-bold text-white">{user?.display_id || user?.username || 'Agent'}</div>
