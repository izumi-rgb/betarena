...
export type LogAction = 'auth.login' | 'auth.logout' | 'auth.refresh' | 'auth.brute_force' | 'bet.place' | 'bet.settle' | 'credit.create' | 'credit.transfer' | 'user.create' | 'user.suspend' | 'user.activate' | 'privilege.grant' | 'privilege.revoke' | 'sqli.attempt';
